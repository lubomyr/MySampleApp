...
class PicassoGlideFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {

        val rootView = inflater!!.inflate(R.layout.fragment_picasso_glide, container, false)
        return rootView
    }

    private fun picassoExamples() {
